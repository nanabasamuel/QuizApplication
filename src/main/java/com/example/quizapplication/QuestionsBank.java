...
public class QuestionsBank {
    ...
    private static List<ListOfQuestions> nursingQuestions() {
        ...
        final ListOfQuestions question3 = new ListOfQuestions("The first cas of Covid positive case in India reported in?", "Kerala", "Tamilnadu", "Gujarat", "Maharashtra", "Kerala", "");
